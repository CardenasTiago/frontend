            ...
            <div v-show="!hideMenuItems" class="flex-none">
                ...
                <div class="dropdown dropdown-end">
                    <div :style="containerStyle" tabindex="0" role="button" class="btn btn-ghost btn-circle">
                        <div class="w-10 h-10 flex items-center justify-center">
                            ...
                            <img v-else :src="user.image" alt="Foto de perfil"
                                class="rounded-full object-cover w-full h-full" ref="imgElement" @load="extractDominantColor"
                    ...
                    <ul tabindex="0"
                        ...
                        <li><a href="/protected/user/myProfile" class="bg-base-100 text-accent">
