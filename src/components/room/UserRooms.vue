<template>
  ...
  <div v-for="(sala, index) in paginatedSalas" :key="index"
    ...
    <a :href="`/protected/room/${sala.id}`" @click="handleCardClick">
      <div
        class="card card-side bg-neutral flex items-stretch min-h-[150px] hover:shadow-lg hover:-translate-y-1 transition duration-300 border-2 border-secondary/30 ">
